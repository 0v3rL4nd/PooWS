...
public abstract class Backtracking<P, S> {
    ...
    protected abstract void scriviSoluzione(P p) throws IOException;
    ...
    protected void tentativo(P p) throws IOException {
    ...
    protected void risolvi() throws IOException {
        ps = puntiDiScelta();
